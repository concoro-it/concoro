...
import { MapPin, Building2, Users, Calendar, Clock } from 'lucide-react'
import { GlowingEffect } from '@/components/ui/glowing-effect'

interface ScadenzaClientProps {
  scadenza: string
...
export default function ScadenzaClient({ 
  scadenza, 
  concorsi = [], 
  totalCount = 0, 
  enti = [],
  ...
  if (!scadenza || (!displayedConcorsi && !loading)) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Scadenza non trovata</h1>
          <p className="text-gray-600">La scadenza richiesta non è disponibile.</p>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <BreadcrumbSEO
            items={[
              ...
              { label: "Scadenza", href: "/bandi" },
              { label: `In scadenza ${scadenza}`, href: `/bandi/scadenza/${deadlineSlug}` }
            ]}
          />
        </div>
      </div>
          ...
          <div className="flex items-center mb-6">
            <div className="">
              <h1 className="text-3xl font-bold text-gray-900">
                Concorsi Pubblici in scadenza {scadenza}
              </h1>
              <p className="text-gray-600 mt-1">
                Non perdere le opportunità in scadenza nel settore pubblico
              </p>
            </div>
          </div>
              ...
              <Card className="relative overflow-hidden transition-all duration-300 hover:shadow-lg">
                ...
                <div className="relative z-10">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium">Concorsi in Scadenza</CardTitle>
                    <Clock className="h-4 w-4 text-muted-foreground" />
                  </CardHeader>
                  <CardContent>
                    <div className="text-2xl font-bold">{totalCount}</div>
                    <p className="text-xs text-muted-foreground">
                      Concorsi che scadono {scadenza}
                    </p>
                  </CardContent>
                </div>
              </Card>
              ...
              <Card className="relative overflow-hidden transition-all duration-300 hover:shadow-lg">
                ...
                <div className="relative z-10">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Organizzazioni con bandi in scadenza
                    </p>
                  </CardContent>
                </div>
              </Card>
              ...
              <Card className="relative overflow-hidden transition-all duration-300 hover:shadow-lg">
                ...
                <div className="relative z-10">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Posizioni lavorative in scadenza
                    </p>
                  </CardContent>
                </div>
              </Card>
            ...
            {displayedConcorsi.length > 0 ? (
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  <h2 className="text-xl font-semibold text-gray-900">
                    Concorsi in Scadenza ({totalCount}) {scadenza}
                  </h2>
                </div>
              ...
              <Card>
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Non ci sono concorsi in scadenza {scadenza} al momento.
                  </p>
                  <p className="text-sm text-gray-500">
                    Torna più tardi per nuove opportunità o esplora altre scadenze.
                  </p>
                </CardContent>
              </Card>
            )}
...
<div className="mt-12 bg-white border rounded-lg p-8">
  ...
  <div className="prose max-w-none text-gray-600">
      <p>
      Non perdere le opportunità di lavoro nel settore pubblico in scadenza {scadenza}. 
      Concoro ti aiuta a trovare i concorsi pubblici che stanno per scadere, 
      con informazioni dettagliate su requisiti, scadenze e procedure di candidatura.
      </p>
      <p>
      Monitoriamo costantemente le scadenze dei bandi pubblici per garantirti 
      di non perdere nessuna opportunità. Candidati subito prima che sia troppo tardi!
      </p>
</div>
...
<div className="mt-8">
  ...
  <div>
      <h4 className="font-medium">Come candidarsi ai concorsi in scadenza {scadenza}?</h4>
      <p>
      Consulta questa pagina per i concorsi in scadenza {scadenza}, accedi ai dettagli 
      di ogni bando e candidati prima della scadenza indicata.
      </p>
  </div>
  <div>
      <h4 className="font-medium">Quando scadono esattamente i concorsi?</h4>
      <p>
      Ogni scheda concorso riporta la data di scadenza esatta. Ti consigliamo di candidarti 
      il prima possibile per evitare di perdere l'opportunità.
      </p>
  </div>
  <div>
      <h4 className="font-medium">Come restare aggiornati sui concorsi in scadenza?</h4>
      <p>
      Visita regolarmente questa pagina per i concorsi in scadenza {scadenza} o 
      attiva le notifiche per essere informato sulle scadenze imminenti.
      </p>
  </div>
  </div>
</div>
