...
import { MapPin, Building2, Users, Calendar, Briefcase } from 'lucide-react'
import { GlowingEffect } from '@/components/ui/glowing-effect'

interface SettoreClientProps {
  settore: string
...
export default function SettoreClient({ 
  settore, 
  concorsi = [], 
  totalCount = 0, 
  enti = [],
  ...
  if (!settore || (!displayedConcorsi && !loading)) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Settore non trovato</h1>
          <p className="text-gray-600">Il settore richiesto non è disponibile.</p>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <BreadcrumbSEO
            items={[
              ...
              { label: settore, href: `/bandi/settore/${settoreSlug}` }
            ]}
          />
        </div>
      </div>
          ...
          <div className="flex items-center mb-6">
            <div className="">
              ...
              <p className="text-gray-600 mt-1">
                Scopri le opportunità di lavoro nel settore {settore}
              </p>
            </div>
          </div>
...
<div className="mt-12 bg-white border rounded-lg p-8">
  ...
  <h2 className="text-2xl font-bold text-gray-900 mb-4">
      Opportunità di Lavoro Pubblico nel settore {settore}
  </h2>
  <div className="prose max-w-none text-gray-600">
      <p>
      Esplora le opportunità di lavoro nel settore {settore} presso enti pubblici. 
      Concoro ti aiuta a trovare i migliori concorsi pubblici nel tuo settore di competenza, 
      con informazioni dettagliate su requisiti, scadenze e procedure di candidatura.
      </p>
      <p>
      Monitoriamo costantemente nuovi bandi e concorsi nel settore {settore}, 
      garantendoti accesso immediato alle ultime opportunità di carriera specializzate nel settore pubblico.
      </p>
</div>
...
<div className="mt-8">
  ...
  <div>
      <h4 className="font-medium">Quali requisiti servono per lavorare nel settore {settore}?</h4>
      <p>
      I requisiti per lavorare nel settore {settore} variano per ogni concorso. 
      Consulta ogni bando per i requisiti specifici di formazione ed esperienza richiesti.
      </p>
  </div>
  <div>
      <h4 className="font-medium">Come trovare concorsi nel settore {settore}?</h4>
      <p>
      Questa pagina elenca tutti i concorsi pubblici attivi nel settore {settore}. 
      Puoi filtrare per ente o località per risultati più specifici alla tua zona.
      </p>
  </div>
  <div>
      <h4 className="font-medium">Quali enti assumono nel settore {settore}?</h4>
      <p>
      Diversi enti pubblici assumono nel settore {settore}. Consulta l'elenco degli enti 
