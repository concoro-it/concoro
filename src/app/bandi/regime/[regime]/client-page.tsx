...
import { MapPin, Building2, Users, Calendar, Settings } from 'lucide-react'
import { GlowingEffect } from '@/components/ui/glowing-effect'

interface RegimeClientProps {
  regime: string
...
export default function RegimeClient({ 
  ...
  if (!regime || (!displayedConcorsi && !loading)) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Regime non trovato</h1>
          <p className="text-gray-600">Il regime richiesto non è disponibile.</p>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <BreadcrumbSEO
            items={[
              ...
              { label: "Regime", href: "/bandi" },
              { label: regime, href: `/bandi/regime/${regimeSlug}` }
            ]}
          />
        </div>
      </div>
          ...
          <div className="flex items-center mb-6">
            <div className="">
              <h1 className="text-3xl font-bold text-gray-900">
                Concorsi Pubblici {regime}
              </h1>
              <p className="text-gray-600 mt-1">
                Scopri le opportunità di lavoro con contratto {regime}
              </p>
            </div>
          </div>
              ...
              <Card className="relative overflow-hidden transition-all duration-300 hover:shadow-lg">
                ...
                <div className="relative z-10">
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Organizzazioni con bandi {regime}
                    </p>
                  </CardContent>
                </div>
              </Card>
            ...
            {displayedConcorsi.length > 0 ? (
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  <h2 className="text-xl font-semibold text-gray-900">
                    Concorsi Disponibili ({totalCount}) con contratto {regime}
                  </h2>
                </div>
              ...
              <Card>
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Non ci sono concorsi attivi con contratto {regime} al momento.
                  </p>
                  <p className="text-sm text-gray-500">
                    Torna più tardi per nuove opportunità o esplora altri regimi.
                  </p>
                </CardContent>
              </Card>
            )}
...
<div className="mt-12 bg-white border rounded-lg p-8">
  ...
  <h2 className="text-2xl font-bold text-gray-900 mb-4">
      Opportunità di Lavoro Pubblico con contratto {regime}
  </h2>
  <div className="prose max-w-none text-gray-600">
      <p>
      Esplora le opportunità di lavoro nel settore pubblico con contratto {regime}. 
      Concoro ti aiuta a trovare i migliori concorsi pubblici con questa tipologia contrattuale, 
      con informazioni dettagliate su requisiti, scadenze e procedure di candidatura.
      </p>
      <p>
      Monitoriamo costantemente nuovi bandi e concorsi con contratto {regime}, 
...
<div className="mt-8">
  ...
  <div>
      <h4 className="font-medium">Cosa significa contratto {regime}?</h4>
      <p>
      I concorsi con contratto {regime} offrono specifiche modalità di impiego nel settore pubblico. 
      Consulta ogni bando per i dettagli contrattuali e le condizioni specifiche.
      </p>
  </div>
  <div>
      <h4 className="font-medium">Come trovare concorsi con contratto {regime}?</h4>
      <p>
      Questa pagina elenca tutti i concorsi pubblici attivi con contratto {regime}. 
      Puoi filtrare per ente o settore per risultati più specifici.
      </p>
  </div>
  <div>
      <h4 className="font-medium">Quali enti offrono contratti {regime}?</h4>
      <p>
      Diversi enti pubblici offrono contratti {regime}. Consulta l'elenco degli enti 
      nella barra laterale per esplorare le opportunità disponibili presso ciascun ente.
      </p>
  </div>
  </div>
</div>
