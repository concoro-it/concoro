...
export const SimpleSelect = React.forwardRef<HTMLSelectElement, SimpleSelectProps>(
  ({ options, value, onValueChange, placeholder, className, ...props }, ref) => {
    return (
      <div className="relative inline-block">
        <select
          ...
          className={cn(
            "appearance-none rounded-md border border-input bg-background px-3 py-1 text-sm shadow-sm transition-colors",
