...
const LayeredLogoAnimation: React.FC<LayerAnimationProps> = ({
  ...
  return (
    <div className="h-screen w-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      <div className="relative">
        ...
        {/* Layer labels (for debugging) */}
      </div>
    </div>
  );
};

// Variant with different animation styles
const LayeredLogoVariations: React.FC = () => {
  ...
  const variations = [
    {
      name: "Smooth Fade",
      props: { animationDuration: 1000, layerDelay: 200, loop: true }
    }
  ];
...
export { LayeredLogoAnimation, LayeredLogoVariations };