  ...
  return (
    <div className={cn("flex items-center justify-center", className)}>
      <div className="relative overflow-hidden [mask-composite:intersect] [mask-image:linear-gradient(to_right,transparent,black_5rem),linear-gradient(to_left,transparent,black_5rem),linear-gradient(to_bottom,transparent,black_5rem),linear-gradient(to_top,transparent,black_5rem)]">
        <div className="grid h-[150px] w-[300px] gap-5 animate-skew-scroll grid-cols-1">
          {items.map((item) => (
            <div
              key={item.id}
...
const defaultItems: TiltedScrollItem[] = [
  { id: "1", text: "Bandi semplificati e leggibili" },
  { id: "2", text: "Riepiloghi comprensibili" },
  { id: "3", text: "Requisiti evidenziati" },
  { id: "4", text: "PDF ufficiali a portata di click" },
  { id: "5", text: "Notifiche personalizzate" },
  { id: "6", text: "Filtri avanzati" },
  { id: "7", text: "Ricerca intelligente" },
  { id: "8", text: "Dashboard intuitive" },
] 