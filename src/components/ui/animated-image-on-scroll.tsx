...
>(({ className, transition, ...props }, ref) => {
  return (
    <motion.button
      ...
      ref={ref}
      className={cn(
        "group relative flex w-fit items-center rounded-full border border-white bg-[#0A1F44]/80 px-6 py-3 shadow-[0px_4px_16px_rgba(255,255,255,0.2)] transition-colors hover:bg-[#0A1F44] text-white font-medium",
        className
      )}
      {...props}
    />
