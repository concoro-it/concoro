...
interface ConcorsiMobileFiltersProps {
  filters: {
    enti: string[];
    localita: string[];
    settori: string[];
...
export function ConcorsiMobileFilters({ 
  filters, 
  currentFilters, 
  showFilterSidebar, 
  onClose,
  onSetLoading
}: ConcorsiMobileFiltersProps) {
  ...
  const updateFilter = (key: string, value: string) => {
    ...
    // Close the filter sidebar after selection
    onClose();
  ...
  return (
    <Sheet open={showFilterSidebar} onOpenChange={onClose}>
